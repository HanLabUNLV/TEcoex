...
genedatadir = "data/TET.cancer/" # default gene data dir
TEdatadir = "data/TET.cancer/" # default TE data dir
print (args)
if (length(args)==2) {
  genedatadir = args[1]
...
if (file.exists(paste0(resultdir,"ddsGenes.RData"))) {
  ...
  batchids <- read.table("data/patient.cancer.info", header=TRUE, sep="\t")
