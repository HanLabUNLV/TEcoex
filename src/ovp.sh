...
bedtools intersect -wa -a ../result.rsem.${TEdatadir}.instance/gene.noovp.TEs.bed -b ~/storage/TETranscript/gtf/hg19/hg19_rmsk_uniq.bed > ../result.rsem.${TEdatadir}.instance/gene.noovp.uniq.TEs.bed
